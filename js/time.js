...
export var timeScale = 5000;

export var isTimePaused = false;
...
export function nowInLunarMonth() {
...
export function fasterTime() {
  if (timeScale < 1000000) {
    timeScale *= 10;
  }
}

export function slowerTime() {
  if (timeScale > 0.1) {
    timeScale /= 10;
  }
}
